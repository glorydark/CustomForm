 ...
 */
@Data
public class HopperFormItemInfo {
    ...
    public HopperFormItemInfo(String name, String[] description, Item item, List<Requirements> requirements, List<String> successCommands, List<String> successMessages, List<String> failCommands, List<String> failMessages, boolean closeForm) {
        this.name = name;
