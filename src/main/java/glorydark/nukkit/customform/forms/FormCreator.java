                ...
                case "Item":
                    ...
                    if (needItemMapList.size() > 0) {
                        for (Map<String, Object> subMap : needItemMapList) {
                            NeedItem item = new NeedItem((String) subMap.get("item"), (List<Map<String, Object>>) subMap.getOrDefault("alternatives", new ArrayList<>()), (Map<String, Object>) subMap.getOrDefault("must_hava_tag", new LinkedHashMap<>()));
