        ...
        for (Map<String, Object> map : requirementConfig) {
            ...
            switch (type) {
                ...
                case "DCurrency":
                    ...
                    break;
                case "Item":
                    itemRequirementData = new ItemRequirementData((boolean) map.getOrDefault("reduce", true), (Boolean) map.getOrDefault("check_tag", true), (Boolean) map.getOrDefault("check_custom_name", true));
